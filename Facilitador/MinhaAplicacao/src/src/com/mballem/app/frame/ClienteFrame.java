...
public class ClienteFrame extends javax.swing.JFrame {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        PreparedStatement pst = conecta.conn.prepareStatement("insert into chatpessoal (chat,pessoa,destino)values (?,?,?)");
        pst.setString(1,txtAreaSend.getText());
        pst.setString(2,txtName.getText());
       // pst.setString(3,(String) listOnlines.getSelectedValue());
        pst.setString(3,(String) this.listOnlines.getSelectedValue());
        pst.executeUpdate();
