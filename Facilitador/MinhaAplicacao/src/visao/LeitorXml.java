        ...
        if(opcao==JFileChooser.APPROVE_OPTION){
          //  String nome_arquivo = filechoose.getSelectedFile().getPath();
            ...
            TxtRota.setText(rota);
              ...
              {    
        try {    
            ImageIcon imagemTituloJanela = new ImageIcon("\\\\hp2017\\e\\Citrix\\Dados NFE\\nfe.gif");                 
                //Caminho do arquivo .JASPER    
                String relatorio = ("\\\\hp2017\\e\\Citrix\\teste\\Danfe.jasper");    
                ...
                mapa.put("Logo","\\\\hp2017\\e\\Citrix\\Dados NFE\\nfe.gif");  
