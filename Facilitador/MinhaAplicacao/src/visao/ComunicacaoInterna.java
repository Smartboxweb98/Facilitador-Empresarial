...
public class ComunicacaoInterna extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Area Conversas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComunicacaoInterna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComunicacaoInterna().setVisible(true);
            }
        });
    }
