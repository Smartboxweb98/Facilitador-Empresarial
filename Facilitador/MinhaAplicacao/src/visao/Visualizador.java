...
public class Visualizador extends javax.swing.JFrame {
    ...
    public Visualizador() {
        initComponents();
        this.setExtendedState(this.getExtendedState()|Visualizador.MAXIMIZED_BOTH);
        ...
        try{
            ...
            Thread t = new Thread(){
                public void run(){
                    ...
                    fila.createCell(1).setCellValue("EMPRESA");
                    fila.createCell(2).setCellValue("DESCRIÇÃO");
                    fila.createCell(3).setCellValue("DESTINATÁRIO");
                    fila.createCell(4).setCellValue("DEPARTAMENTO");
                    fila.createCell(5).setCellValue("DATA");
                    fila.createCell(6).setCellValue("DATA ENTREGA");
                    fila.createCell(7).setCellValue("HORÁRIO");
                    fila.createCell(8).setCellValue("USUÁRIO");
                    fila.createCell(9).setCellValue("RECEBIMENTO");
                    fila.createCell(10).setCellValue("ENTREGA");
                    fila.createCell(11).setCellValue("CORREIO");
                    fila.createCell(12).setCellValue("BAIXA");
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            preenchertabela("select * from usuarios where data like '%" + jTextField1.getText() + "%' and destinatario != 'AC'");
        }
    ...
    private void jTextField6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField6KeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            preenchertabela("select * from usuarios where horario like '%" + jTextField6.getText() + "%' and destinatario != 'AC'");
        }
    ...
    private void jTextField4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField4KeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            preenchertabela("select * from usuarios where dataentrega like '%" + jTextField4.getText() + "%' and destinatario != 'AC'");
        }
    ...
    private void jTextFieldPesquisar3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPesquisar3KeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            preenchertabela("select * from usuarios where destinatario like '%" + jTextFieldPesquisar3.getText() + "%' and destinatario != 'AC'");
        }
    ...
    private void jTextFieldPesquisarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPesquisarKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            preenchertabela("select * from usuarios where descricao like '%" + jTextFieldPesquisar.getText() + "%' and destinatario != 'AC'");
            //conecta.desconecta();
        }
    ...
    private void jTextFieldPesquisar2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPesquisar2KeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            preenchertabela("select * from usuarios where empresa like '%" + jTextFieldPesquisar2.getText() + "%' and destinatario != 'AC'");
        }
    ...
    public void preenchertabela(String SQL){
        ...
        String [] Colunas = new String[]{"ID","EMPRESA","DESCRICAO","DESTINATARIO","DEPARTAMENTO","DATA","DATAENTREGA","HORARIO","RECEBIMENTO","USUARIO","ENTREGA","TIPO","BAIXA","DIABAIXA","HORARIOBAIXA"};
        conecta.conectaBanco();
        conecta.executaSQL(SQL);
        try {
           conecta.rs.first(); 
        do{
        dados.add(new Object[]{conecta.rs.getInt("id"),conecta.rs.getString("empresa"),conecta.rs.getString("descricao"),conecta.rs.getString("destinatario"),conecta.rs.getString("departamento"),conecta.rs.getString("data"),conecta.rs.getString("dataentrega"),conecta.rs.getString("horario"),conecta.rs.getString("recebimento"),conecta.rs.getString("usuario"),conecta.rs.getString("entrega"),conecta.rs.getString("correio"),conecta.rs.getString("baixa"),conecta.rs.getString("diabaixa"),conecta.rs.getString("horariobaixa")}); 
        ...
        jTableEstado.getColumnModel().getColumn(0).setPreferredWidth(40);
        ...
        jTableEstado.getColumnModel().getColumn(2).setPreferredWidth(420);
        ...
        jTableEstado.getColumnModel().getColumn(4).setPreferredWidth(108);
        ...
        jTableEstado.getColumnModel().getColumn(10).setPreferredWidth(75);
        jTableEstado.getColumnModel().getColumn(10).setResizable(false);
        jTableEstado.getColumnModel().getColumn(11).setPreferredWidth(55);
        ...
        jTableEstado.getColumnModel().getColumn(13).setPreferredWidth(100);
